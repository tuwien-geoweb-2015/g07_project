<?php
  ...
  // Funktion mail(adress,subject,message,header) f�r Versenden per Mail - gew�nschte Mailadresse eintragen
  mail( "florian_keringer56@yahoo.de",
        "geoweb: Feedback Formular",
        "Gesendet von ".$anrede." ".$name." (".$team."): ".$message,
        "From: $email" )
       OR DIE("Fehler: Feedback nicht gesendet.");

  // Daten zus�tzlich in Datenbank speichern (siehe auch Block2-PhpSql-Abschnitt)
  // Tabelle feedback muss in Datenbank angelegt sein
  // (Beispiel-Tabelle siehe geoweb/2015/ifip/ifip_db.sqlite-Datenbank)

  include 'geoweb_db_open.php'; // ifip_db.sqlite-Datenbank �ffnen
  ...
  include 'geoweb_db_close.php'; // Datenbank schlie�en
